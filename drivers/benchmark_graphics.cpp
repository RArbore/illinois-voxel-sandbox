...
int main(int argc, char *argv[]) {
	...
	const float linear = static_cast<float>(i) / static_cast<float>(num_objects);
	...
	glm::mat3x4 transform = {1.0F, 0.0F, 0.0F, 7.0F * cosf(radians),
				 0.0F, 1.0F, 0.0F, cosf(radians * 4.0F),
				 0.0F, 0.0F, 1.0F, 7.0F * sinf(radians)};
