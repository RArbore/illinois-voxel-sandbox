...
RawVoxelChunk *VoxelManager::generate_procedural_chunk(const glm::vec3 &position, const glm::vec3 &size) {
    RawVoxelChunk *new_chunk = new RawVoxelChunk(position, (int)size.x, (int)size.y, (int)size.z);
...
double VoxelManager::densityfunction_(const glm::vec3 &position) {
