...
#ifndef ILLINOIS_VOXEL_SANDBOX_MINECRAFT_ID_LIST_H
#define ILLINOIS_VOXEL_SANDBOX_MINECRAFT_ID_LIST_H
...
const std::vector<AnvilBlock> ANVIL_BLOCK_IDS = {
    {0, 0, "Air", "air"},
    {1, 0, "Stone", "stone"},
    {1, 1, "Granite", "stone"},
    ...
    {2256, 0, "13 Disc", "record_13"},
    {2257, 0, "Cat Disc", "record_cat"},
    {2258, 0, "Blocks Disc", "record_blocks"},
    {2259, 0, "Chirp Disc", "record_chirp"},
    {2260, 0, "Far Disc", "record_far"},
    {2261, 0, "Mall Disc", "record_mall"},
    {2262, 0, "Mellohi Disc", "record_mellohi"},
    {2263, 0, "Stal Disc", "record_stal"},
    {2264, 0, "Strad Disc", "record_strad"},
    {2265, 0, "Ward Disc", "record_ward"},
    {2266, 0, "11 Disc", "record_11"},
    {2267, 0, "Wait Disc", "record_wait"}
};

std::string anvilGetTypeNameByBlockId(int id, int meta) {
    for (const auto& entry : ANVIL_BLOCK_IDS) {
        if (entry.id == id && entry.meta == meta) {
            return entry.text_type;
        }
    }
    return "";
}

#endif // ILLINOIS_VOXEL_SANDBOX_MINECRAFT_ID_LIST_H
