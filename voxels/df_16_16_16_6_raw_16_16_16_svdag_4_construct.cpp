...
static std::vector<uint32_t> df_16_16_16_6_raw_16_16_16_svdag_4_construct_node(Voxelizer &voxelizer, std::vector<uint32_t> &buffer, uint32_t lower_x, uint32_t lower_y, uint32_t lower_z, bool &is_empty);

static std::vector<uint32_t> raw_16_16_16_svdag_4_construct_node(Voxelizer &voxelizer, std::vector<uint32_t> &buffer, uint32_t lower_x, uint32_t lower_y, uint32_t lower_z, bool &is_empty);

static std::array<uint32_t, 8> svdag_4_construct_node(Voxelizer &voxelizer, std::vector<uint32_t> &buffer, uint32_t lower_x, uint32_t lower_y, uint32_t lower_z, bool &is_empty, std::unordered_map<std::array<uint32_t, 8>, uint32_t> &deduplication_map);
...
std::vector<uint32_t> df_16_16_16_6_raw_16_16_16_svdag_4_construct(Voxelizer &voxelizer) {
    ...
    bool is_empty;
    auto root_node = df_16_16_16_6_raw_16_16_16_svdag_4_construct_node(voxelizer, buffer, 0, 0, 0, is_empty);
